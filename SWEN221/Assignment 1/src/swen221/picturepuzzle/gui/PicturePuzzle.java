...
public class PicturePuzzle extends JFrame {
	...
	/**
	 * Sets the dimensions of the generated puzzle.
	 * 
	 * @param e The size selection made.
	 */
	...
	/**
	 * Creates the puzzle picture for the game.
	 * 
	 * @param p The puzzle picture.
	 */
