...
public class Location {
	...
	private static final double CENTRE_LAT = -12.499435;
	private static final double CENTRE_LON = 130.94329;
	...
	/**
	 * Return distance squared between this location and another
	 */
	...
	public boolean isClose(Location other, double dist) {
		return (this.x - other.x)*(this.x - other.x) + (this.y - other.y)*(this.y-other.y) <= dist*dist;
	}
